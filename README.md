...
1. name for the dos files list: `df="$cITCP/encoding/Vim/grep_CRLF.ffl"` (using my [$vimfiles/syntax/ffl.vim](https://github.com/harriott/vimfiles/blob/master/vim/syntax/ffl.vim))
1. `cd $vimfiles`
